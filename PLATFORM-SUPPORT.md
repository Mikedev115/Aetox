...
- **เฟส 0–2 เสร็จ** — `desktop/` **คอมไพล์และเทสต์ผ่านครบทั้งสาม OS** แล้ว ที่เหลือคือแท็บ browser
- ยกเว้นแท็บ browser ทุกอย่างพร้อมใช้บน Linux: chat, sessions, MCP, skills, files, tools, review, **เทอร์มินัล**
- **macOS ยังไม่เคยถูกรันเลยสักครั้ง** — พิสูจน์ได้แค่คอมไพล์/type-check `macos-latest` ใน CI คือที่แรกที่จะรันจริง
...
> **ระวังการอ่านตาราง:** ✅ ของ Linux = *รันจริงบนเคอร์เนล Linux แล้วผ่าน* · macOS **ไม่เคยถูกรันเลย** — ไม่มี container ให้รัน และรัน macOS ใน VM บนเครื่องที่ไม่ใช่ Apple ผิดสัญญาอนุญาต
