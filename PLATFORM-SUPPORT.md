...
[BENCHMARK.md](BENCHMARK.md) §4 วัด Aetox v1.7.2 ได้ **83.4 MB** (สองไฟล์ตั้งแต่ 1.6.0) เล็กกว่าคู่แข่ง 2–34 เท่า ด้วยเหตุผลว่า *ใช้ webview ที่ OS มีอยู่แล้ว ไม่ได้แบก Chromium มาเอง* — เหตุผลนั้นยังจริงบน macOS เสมอ แต่**บน Linux ขึ้นกับวิธีแพ็ก**:
