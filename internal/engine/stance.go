...
// field.
func (a *Engine) SetStance(name string) (string, error) {
...
func (a *Engine) stanceNarrowedByAgent(conv *conversation, next mode.Stance) {
	if conv == nil {
		return
	}
