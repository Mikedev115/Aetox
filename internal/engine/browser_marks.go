...
// is turned on later.
func (a *Engine) markCursorMove(id AgentTabID, p point, press bool) time.Duration {
	var tab *browserTab
	if a.browsers != nil {
...
func (a *Engine) markCursorDrag(id AgentTabID, from, to point, sweep time.Duration) {
	var tab *browserTab
	if a.browsers != nil {
		tab = a.browsers.tab(string(id))
	}
...
func (a *Engine) restorePageCursor(id AgentTabID) {
...
func (a *Engine) markPageClick(id AgentTabID, p point) {
	if !a.pageMarksOn() {
		return
	}
...
func (a *Engine) markPageScroll(id AgentTabID, to string, holdMS int) {
	if !a.pageMarksOn() {
		return
	}
...
func (a *Engine) clearPageMarks(id AgentTabID) {
