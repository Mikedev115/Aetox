...
func (a *Engine) SavePlanText(sessionID, text string) string {
...
// thought.
func (a *Engine) markHandEdited(sessionID string) {
...
func (a *Engine) planHandEditNote(sessionID string) string {
	a.goalRunSet().mu.Lock()
	defer a.goalRunSet().mu.Unlock()
