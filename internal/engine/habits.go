...
func (a *Engine) ListRecurringRequests() []RecurringRequest {
	db, err := a.database()
	if err != nil {
		return nil
	}
...
func (a *Engine) DismissRecurringRequest(normalized, sampleText string) error {
	db, err := a.database()
	if err != nil {
		return err
	}
...
func (a *Engine) RestoreRecurringRequest(normalized string) error {
	db, err := a.database()
	if err != nil {
		return err
	}
