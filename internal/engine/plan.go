...
// plan (goal_run.go).
func (a *Engine) emitPlan(sessionID string, plan Plan) {
...
func (a *Engine) loadPlan(sessionID string) (*Plan, error) {
...
func (a *Engine) savePlan(sessionID string, p Plan) error {
	db, err := a.database()
	if err != nil {
		return err
	}
...
func (a *Engine) SessionPlan(sessionID string) Plan {
