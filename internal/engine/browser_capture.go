...
func (a *Engine) waitShown(ctx context.Context, tab *browserTab, limit time.Duration) {
...
func (a *Engine) pageViewport(id AgentTabID) (browserActResult, bool) {
...
func (a *Engine) deckRendererNote(pageURL string) string {
...
func (a *Engine) writeBrowserShot(png []byte, marked bool) (string, error) {
