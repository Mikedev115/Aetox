...
func (a *Engine) PreparedReplyOn() bool { return preparedReplyOn() }

// SetPreparedReplyOn persists it.
func (a *Engine) SetPreparedReplyOn(on bool) error {
...
// arrives.
func (a *Engine) maybePrepareReply(conv *conversation, question, answer string) {
...
func (a *Engine) prepareReplies(ctx context.Context, conv *conversation, question, answer string) ([]PreparedReply, error) {
