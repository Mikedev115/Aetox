...
func (a *Engine) ListExternalSkills() []skill.DiscoveredSkill {
...
func (a *Engine) SkillsDir() string {
...
func (a *Engine) SkillScanIssues() []string {
...
func (a *Engine) InstallSkillsFromZipAt(path string) (string, error) {
...
// reveals it.
func (a *Engine) SkillsFolderPath() (string, error) {
	dir := skill.DefaultSkillsDir()
	if dir == "" {
		return "", fmt.Errorf("หาโฟลเดอร์บ้านของผู้ใช้ไม่เจอ")
	}
...
func (a *Engine) InstallSkillFromGitHub(repoURL string) (string, error) {
...
func (a *Engine) RemoveExternalSkill(name string) error {
