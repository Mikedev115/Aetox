...
func (a *Engine) appendTurn(conv *conversation, userMsg, agentMsg SessionMessage) int64 {
	db, err := a.database()
...
func (a *Engine) appendFailedTurn(conv *conversation, agentMsg SessionMessage, cause error) int64 {
	db, err := a.database()
	sessionID := conv.id
...
func (a *Engine) closeInterruptedTurns() int {
	if a.turnBusy() {
		return 0
	}
	db, err := a.database()
...
func (a *Engine) ListSessions() []SessionMeta {
...
func (a *Engine) ListSessionsAt(desk string) []SessionMeta {
	out := []SessionMeta{}
	db, err := a.database()
	if err != nil {
		return out
...
func (a *Engine) SessionMode(id string) string {
	db, err := a.database()
	if err != nil {
...
func (a *Engine) liveDesk(id string) string {
	if id != "" && id == a.cur().id {
...
func (a *Engine) SessionAgent(id string) string {
	db, err := a.database()
	if err != nil {
...
func (a *Engine) liveChair(id string) string {
	if id != "" && id == a.cur().id {
		return a.cur().chair
	}
	return ""
...
func (a *Engine) SessionTeam(id string) string {
	db, err := a.database()
	if err != nil {
...
func (a *Engine) liveTeam(id string) string {
	if id != "" && id == a.cur().id {
		return a.cur().team
	}
	return ""
...
func (a *Engine) SearchSessions(query string) []SessionMeta {
	out := []SessionMeta{}
...
func (a *Engine) touchProject(root string) {
...
func (a *Engine) ForgetProject(root string) (ProjectStatus, error) {
	root = strings.TrimSpace(root)
	if root == "" {
...
func (a *Engine) ListSessionsForDoor(filter DeskFilter) []SessionMeta {
	out := []SessionMeta{}
	db, err := a.database()
	if err != nil {
		return out
...
// times sooner here.
func (a *Engine) SearchSessionsForDoor(query string, filter DeskFilter) []SessionMeta {
	out := []SessionMeta{}
	q := strings.TrimSpace(query)
	db, err := a.database()
	if err != nil || q == "" {
...
func (a *Engine) ListAllSessions() []SessionMeta {
	out := []SessionMeta{}
	db, err := a.database()
	if err != nil {
		return out
...
func (a *Engine) SearchAllSessions(query string) []SessionMeta {
	out := []SessionMeta{}
	q := strings.TrimSpace(query)
	db, err := a.database()
	if err != nil || q == "" {
...
func (a *Engine) LoadSessionAnyProject(id string) ([]SessionMessage, error) {
	db, err := a.database()
	if err != nil {
		return nil, err
	}
...
// with memory intact.
func (a *Engine) LoadSession(id string) ([]SessionMessage, error) {
...
func (a *Engine) readTranscript(id, key string) ([]SessionMessage, error) {
	db, err := a.database()
	if err != nil {
		return nil, err
	}
...
func (a *Engine) SessionTranscript(id string) ([]SessionMessage, error) {
	db, err := a.database()
	if err != nil {
		return nil, err
	}
...
// returns its id.
func (a *Engine) NewSession() (string, error) {
	a.startNewSession()
	return a.cur().id, nil
}
...
func (a *Engine) NewSessionAt(desk string) (string, error) {
...
func (a *Engine) NewChairSession(chair string) (string, error) {
...
func (a *Engine) NewChairSessionAt(desk, chair, team string) (string, error) {
	a.startNewSession()
...
func (a *Engine) NewTeamSession(desk, team string) (string, error) {
	a.startNewSession()
...
func (a *Engine) setStation(desk, chair, team string) error {
...
func (a *Engine) enterProject(root string) {
	a.touchProject(root)
...
func (a *Engine) CurrentSessionID() string {
	return a.cur().id
}
...
func (a *Engine) DeleteSession(id string) error {
...
func (a *Engine) sweepAttachments(root string) {
	root = strings.TrimSpace(root)
	if root == "" {
		return
	}
...
func (a *Engine) explainARecordedModelThatWillNotStart(conv *conversation, provider, modelName string) {
