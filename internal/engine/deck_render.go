...
func (a *Engine) withExportTab(ctx context.Context, fileURL string, work func(call engineCaller) error) error {
...
func (a *Engine) waitForDeckLoad(ctx context.Context, host *browserHost, id string) error {
