...
func (a *Engine) ListSubagentProfiles() []subagent.Profile {
...
func (a *Engine) ReadSubagentProfile(name string) (string, error) {
...
func (a *Engine) SaveSubagentProfile(name, body string) error {
...
func (a *Engine) SaveAgentProfile(name, body string) error {
	return subagent.SaveAgent(name, body)
}

// DeleteSubagentProfile removes a user profile. Deleting a shadow restores the
// bundled profile it was hiding.
func (a *Engine) DeleteSubagentProfile(name string) error {
...
func (a *Engine) SetSubagentModel(name, modelName string) error {
...
func (a *Engine) SubagentsFolderPath() (string, error) {
...
func (a *Engine) AgentsFolderPath() (string, error) {
...
func (a *Engine) AgentSkills(name string) []AgentSkillInfo {
...
func (a *Engine) AgentNeeds(name string) []subagent.Requirement {
...
func (a *Engine) AgentSkillsFolderPath(name string) (string, error) {
...
func (a *Engine) AgentHomePath(name string) (string, error) {
...
func (a *Engine) AgentGate(name string) AgentGate {
...
func (a *Engine) AgentBlocked(name string) bool { return a.AgentGate(name).Blocked }
