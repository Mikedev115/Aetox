...
func (a *Engine) BackgroundTasks() []BackgroundTask {
...
func (a *Engine) BackgroundRuns() []BackgroundRun {
	if a.cur().delegations == nil {
...
func (a *Engine) StopBackgroundTask(id string) bool {
	if a.cur().delegations == nil {
		return false
	}
...
func (a *Engine) StopQueuedTasks() int {
	if a.cur().delegations == nil {
		return 0
	}
...
func (a *Engine) StopBackgroundRun(runID string) int {
	if a.cur().delegations == nil {
		return 0
	}
