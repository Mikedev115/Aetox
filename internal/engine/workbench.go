...
func (a *Engine) mintAgentTabID() AgentTabID {
	for {
...
func (a *Engine) workbenchOpenBrowser(ctx context.Context, url string, newTab bool, owner string) (title, finalURL, duplicateOf string, err error) {
	if a.ctx == nil {
...
func (a *Engine) agentTab() (AgentTabID, error) {
	h := a.browsers
	if h == nil {
...
func (a *Engine) agentTabPeek() string {
	h := a.browsers
	if h == nil {
		return ""
	}
...
func (a *Engine) browserWhyRefMissed(id AgentTabID, ref int) string {
	var t *browserTab
	if a.browsers != nil {
...
func (a *Engine) browserWhere(id AgentTabID) string {
	if a.browsers == nil {
		return ""
	}
	t := a.browsers.tab(string(id))
...
func (a *Engine) workbenchReadBrowser(filter string) (title, url string, snap browserSnapshot, err error) {
	id, err := a.agentTab()
	if err != nil {
...
type browserReadSkill struct{ app *Engine }
...
type browserClickSkill struct{ app *Engine }
...
type browserTypeSkill struct{ app *Engine }
