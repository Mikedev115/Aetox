...
func (a *Engine) BrowserDevices() []DeviceProfile { return browserDevices }
...
func (a *Engine) applyDevice(ctx context.Context, id string, dev DeviceProfile) error {
...
// "" for เต็มแผง.
func (a *Engine) BrowserSetDevice(id, name string) error {
