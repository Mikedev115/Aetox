...
func (a *Engine) ListChairs() []Chair {
...
func (a *Engine) ChairStarters(name, locale string) subagent.StarterSet {
...
// an empty one.
func (a *Engine) SaveChairStarters(name, locale string, set subagent.StarterSet) error {
...
// line nobody reads.
func (a *Engine) ChairStartersFile(locale string) string {
...
func (a *Engine) chairActivity() map[string]chairActivity {
...
func (a *Engine) ListReceivedJobs(limit int) []ReceivedJob {
	out := []ReceivedJob{}
