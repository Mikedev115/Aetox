...
func (a *Engine) EnginesFor(family, agent string) []connect.Status {
...
func (a *Engine) UseEngine(family, agent, id string) error {
...
func (a *Engine) SetConnectionStartCommand(id, command string) error {
...
func (a *Engine) StartConnectionServer(id string) error {
...
func (a *Engine) CheckConnectionServer(id string) (bool, error) {
	row, ok := connect.StatusOf(id)
	if !ok {
...
func (a *Engine) ConnectAccount(id, token, baseURL string, targets []string) (connect.Account, error) {
...
func (a *Engine) SetConnectionTargets(id string, targets []string) error {
...
func (a *Engine) VerifyConnection(id string) (connect.Account, error) {
