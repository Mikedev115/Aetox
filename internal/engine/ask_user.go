...
func (a *Engine) approveToolCall(conv *conversation, ctx context.Context, command, reason string) (bool, error) {
...
func (a *Engine) beginUserQuestion(conv *conversation, question string, options []string) (chan string, error) {
	a.askMu.Lock()
...
func (a *Engine) endUserQuestion(conv *conversation) {
	a.askMu.Lock()
	defer a.askMu.Unlock()
	conv.askCh = nil
...
func (a *Engine) AnswerUserQuestion(sessionID, answer string) {
