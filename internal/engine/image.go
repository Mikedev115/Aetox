...
func (a *Engine) imageOptions() imagegen.Options {
	cfg := a.cur().cfg
...
func (a *Engine) SetImageEngine(id string) error {
...
func (a *Engine) SetImageModelName(name string) error {
...
func (a *Engine) ImageStatus() string {
