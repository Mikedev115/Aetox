...
func (a *Engine) VideoEditorCommand() []string {
...
func (a *Engine) VideoEditorEnvironment() map[string]string {
...
func (a *Engine) VideoToolingStatus() VideoToolingStatus {
...
func (a *Engine) VideoEditorTools() []string {
...
func (a *Engine) connectVideoEditor() error {
...
func (a *Engine) VideoReadiness(agent string) VideoReadiness {
...
func (a *Engine) VideoCheckSeen() bool {
...
func (a *Engine) MarkVideoCheckSeen() {
...
func (a *Engine) VideoEditorHelpURL(what string) string {
