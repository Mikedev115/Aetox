...
func (a *Engine) CapabilityStatuses() []capability.Status {
...
func (a *Engine) CapabilitiesInstalling() bool {
...
// second download.
func (a *Engine) InstallCapabilities(capabilities []string) bool {
	if capabilities == nil {
		capabilities = []string{}
	}
...
func (a *Engine) runCapabilityInstall(missing []capability.Component) {
	defer func() {
		a.capabilities.mu.Lock()
...
func (a *Engine) ToolInstallPlan(name string) ToolInstallPlan {
...
func (a *Engine) CapabilityForServer(server string) string {
