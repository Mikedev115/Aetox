...
func (a *Engine) BrowserCapturePNG(id string) (string, error) {
...
func (a *Engine) BrowserCaptureFullPNG(ctx context.Context, id string) (dataURL string, cutAt int, err error) {
