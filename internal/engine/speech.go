...
// on mid-render.
func (a *Engine) ListSpeechModels() []SpeechModelInfo {
	out := []SpeechModelInfo{}
...
func (a *Engine) SetSpeechModel(path string) error {
...
func (a *Engine) SpeechModelDirs() []SpeechDirInfo {
	out := []SpeechDirInfo{}
...
func (a *Engine) SpeechStatus() string {
