...
func (a *Engine) ExternalEngineStatus(providerName string) cliagent.Status {
...
func (a *Engine) runCLIEngineTurn(conv *conversation, ctx context.Context, engine cliagent.Engine, text string) (SessionMessage, SessionMessage, error) {
