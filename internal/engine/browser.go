...
func (a *Engine) dialogNote(id AgentTabID) string {
	if a.browsers == nil {
		return ""
	}
...
func (a *Engine) engineNote(id AgentTabID) string {
	if a.browsers == nil {
		return ""
	}
	t := a.browsers.tab(string(id))
...
type browserHost struct {
	...
	// app: the × on a detached window’s own frame. Set by the Engine that owns
...
func newBrowserHost(app *Engine) *browserHost {
	return &browserHost{
		app:     app,
...
// build tag. desktop/frontend/wailsjs/go/main/Engine.d.ts is generated from this
...
func (a *Engine) browserHostLazy() (*browserHost, error) {
	a.terminalsMu.Lock()
	if a.browsers == nil {
...
func (a *Engine) onTab(id string, fn func(tabView, *browserTab)) {
...
func (a *Engine) BrowserOpen(id, url, fallback string, x, y, w, h int) error {
...
func (a *Engine) BrowserNavigate(id, url, fallback string) {
...
func (a *Engine) BrowserSetBounds(id string, x, y, w, h int) {
	a.onTab(id, func(v tabView, t *browserTab) {
...
func (a *Engine) BrowserSetZoom(id string, factor float64) {
	if factor <= 0 {
		factor = 1
	}
	a.onTab(id, func(v tabView, t *browserTab) {
...
func (a *Engine) raiseDetached(id string) {
...
// at four sites.
func (a *Engine) detachedTab(id string) bool {
	if a.browsers == nil {
		return false
	}
...
func (a *Engine) BrowserDetach(id string) {
	if host, err := a.browserHostLazy(); err == nil {
		host.detach(id)
	}
}
...
func (a *Engine) BrowserSetVisible(id string, visible bool) {
	a.onTab(id, func(v tabView, t *browserTab) {
		t.visMu.Lock()
		t.hidden = !visible
		t.visMu.Unlock()
...
// of them.
func (a *Engine) BrowserBack(id string)    { a.browserEval(id, "history.back()") }
func (a *Engine) BrowserForward(id string) { a.browserEval(id, "history.forward()") }
func (a *Engine) BrowserReload(id string)  { a.browserEval(id, "location.reload()") }
...
func (a *Engine) BrowserSetScreenShape(id string, radius, notchW, notchH, notchY int) {
	a.onTab(id, func(v tabView, _ *browserTab) { v.setShape(radius, notchW, notchH, notchY) })
}

func (a *Engine) BrowserOpenDevTools(id string) {
	a.onTab(id, func(v tabView, _ *browserTab) { v.openDevTools() })
}

func (a *Engine) browserEval(id, js string) {
...
//
// Called by the frontend right after it (re)loads (Engine.svelte onMount). The Go
...
func (a *Engine) CloseAllBrowserTabs() {
	if a.browsers == nil {
		return
	}
...
func (a *Engine) BrowserClose(id string) {
...
func (a *Engine) BrowserCloseForTeardown(id string) {
	a.closeTab(id, closedByApp)
}
...
func (a *Engine) closeTab(id string, why closeReason) {
	host, err := a.browserHostLazy()
	if err != nil {
		return
	}
...
func (a *Engine) BrowserGetText(id string) (string, error) {
...
func (a *Engine) browserSnapshot(id, filter string) (browserSnapshot, error) {
	host, err := a.browserHostLazy()
	if err != nil {
...
func (a *Engine) browserActOn(id string, build func(token string) string) (res browserActResult, answered bool, err error) {
...
func (a *Engine) browserActOnFor(id string, build func(token string) string, wait time.Duration) (res browserActResult, answered bool, err error) {
	host, err := a.browserHostLazy()
	if err != nil {
...
func (a *Engine) browserClickRef(id string, ref int) (browserActResult, bool, error) {
...
func (a *Engine) BrowserClickRef(id string, ref int) error {
...
// no submit button).
func (a *Engine) browserTypeRef(id string, ref int, text string, enter bool) (browserActResult, bool, error) {
...
func (a *Engine) BrowserTypeRef(id string, ref int, text string, enter bool) error {
