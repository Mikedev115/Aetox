...
func (a *Engine) RunnableLanguages() map[string]string {
...
func (a *Engine) RunChatCommand(command string) (RunBlockResult, error) {
...
// second set of rules.
func (a *Engine) runThroughShell(command string) (RunBlockResult, error) {
