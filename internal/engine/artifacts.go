...
func (a *Engine) ListArtifacts() []Artifact {
...
func (a *Engine) ListArtifactsIn(want string) ArtifactPage {
	all := []Artifact{}
...
func (a *Engine) ListArtifactsForSession(sessionID string) ArtifactPage {
...
func (a *Engine) artifactRoots() []string {
...
func (a *Engine) insideOutput(path string) (string, bool) {
...
func (a *Engine) ArtifactPath(path string) (string, error) {
...
func (a *Engine) DeleteArtifact(path string) error {
	full, ok := a.insideOutput(path)
	if !ok {
