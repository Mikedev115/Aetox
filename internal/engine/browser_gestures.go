...
// nothing.
func (a *Engine) resolveTarget(id AgentTabID, t browserTarget) (browserActResult, error) {
	ref := t.Ref
	if t.Find != "" {
...
func (a *Engine) findByText(id AgentTabID, text string) (int, error) {
...
// off.
func (a *Engine) aim(id AgentTabID, t browserTarget, press bool) (browserActResult, error) {
...
type browserHoverSkill struct{ app *Engine }
...
type browserDragSkill struct{ app *Engine }
...
type browserKeySkill struct{ app *Engine }
...
type browserUploadSkill struct{ app *Engine }
...
// nothing until it is.
func (a *Engine) setFileInput(ctx context.Context, id string, ref int, abs string) error {
...
func (a *Engine) pageState(id AgentTabID, wait time.Duration) (browserActResult, bool) {
...
func (a *Engine) settleAfterAct(id AgentTabID, before browserActResult) (browserActResult, bool) {
...
func (a *Engine) changeNote(id AgentTabID, before browserActResult) string {
