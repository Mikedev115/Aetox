...
func (a *Engine) runEngine(ctx context.Context, id string, plan []engineCall) error {
...
func (a *Engine) enginePoint(id string, p point) point {
	if a.browsers == nil {
		return p
	}
...
func (a *Engine) typeByKeys(ctx context.Context, id string, res browserActResult, text string, enter bool) (clicked bool, err error) {
...
func (a *Engine) clickByMouse(ctx context.Context, id string, x, y float64) error {
	return a.pressByMouse(ctx, id, point{x, y}, "left", 1)
}

// pressByMouse is a click of any button, any count, at a point.
func (a *Engine) pressByMouse(ctx context.Context, id string, p point, button string, count int) error {
...
func (a *Engine) hoverByMouse(ctx context.Context, id string, p point) error {
...
func (a *Engine) dragByMouse(ctx context.Context, id string, from, to point) error {
...
func (a *Engine) wheelByMouse(ctx context.Context, id string, p point, dx, dy float64) error {
...
func (a *Engine) sendKeys(ctx context.Context, id string, keys string) (said []string, err error) {
