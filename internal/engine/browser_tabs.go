...
// produced.
func (a *Engine) agentTabs() []string {
	h := a.browsers
	if h == nil {
		return nil
	}
...
func (a *Engine) agentTabOn(pageURL string) (AgentTabID, bool) {
...
func (a *Engine) agentTabList() string {
	ids := a.agentTabs()
	if len(ids) == 0 {
...
func (a *Engine) selectAgentTab(id, owner string) error {
...
func (a *Engine) selectRaiseNote(ctx context.Context, id string) string {
...
func (a *Engine) closeAgentTab(id string) error {
	if err := a.mustOwn(id); err != nil {
		return err
	}
...
func (a *Engine) mustOwn(id string) error {
