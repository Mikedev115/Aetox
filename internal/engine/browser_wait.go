...
func (a *Engine) waitForText(ctx context.Context, id AgentTabID, needle string, timeout time.Duration) (bool, error) {
	host := a.browsers
	if host == nil {
...
type browserWaitSkill struct{ app *Engine }
...
func (a *Engine) reportWaiting(ctx context.Context, id AgentTabID, text string, timeout time.Duration) func() {
...
type browserDialogSkill struct{ app *Engine }
