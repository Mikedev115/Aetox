...
func (a *Engine) GitBranches() []GitBranch {
	out := []GitBranch{}
...
func (a *Engine) GitSwitchBranch(name string) (string, error) {
...
// asks for it.
func (a *Engine) GitCreateBranch(name string) (string, error) {
	return a.runGitSwitch(name, true)
}

func (a *Engine) runGitSwitch(name string, create bool) (string, error) {
	if !a.projectFocused {
