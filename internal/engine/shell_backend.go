...
func (a *Engine) shellBackend() proc.Backend {
...
func (a *Engine) Shells() []ShellOption {
...
func (a *Engine) CurrentShell() ShellOption {
...
func (a *Engine) SetShell(setting string) error {
