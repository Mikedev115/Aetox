...
func (a *Engine) SessionEdits(sessionID string) EditPage {
...
func (a *Engine) notifyFilesChanged(conv *conversation, run turn.ToolRun) {
	if conv == nil || !run.OK {
		return
	}
...
func (a *Engine) editsFromRun(sessionID, tool, args, at string) []EditedFile {
...
func (a *Engine) onDisk(sessionID, raw string) (string, bool) {
...
func (a *Engine) rootFor(sessionID string) string {
...
// resolved them.
func (a *Engine) outputSubdirFor(sessionID string) string {
