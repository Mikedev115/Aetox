...
func TestNewDefaultRegistryRegistersAllBuiltins(t *testing.T) {
	...
	want := []string{
		...
		"git", "fs", "shell", "shell_output", "shell_kill", "write", "edit", "grep", "glob", "apply_patch", "notebook_edit", "diagnostics", "delete", "plugin_install", "image_ocr", "video_ocr", "pdf_read", "audio_transcribe",
