---
description: โหมดเขียนโค้ด — ไฟล์ เชลล์ เครื่องมือโค้ด และเว็บ ไม่แบกเครื่องมือสไลด์/เอกสาร
...
specialized-session work — say so rather than approximating it here.
