...
func (a *App) emitPlanReport(sessionID string, rep PlanReport) {
...
func (a *App) loadPlanReports(sessionID string) ([]PlanReport, error) {
...
func (a *App) savePlanReport(sessionID string, r PlanReport) error {
	db, err := a.database()
	if err != nil {
		return err
	}
...
func (a *App) SessionPlanReports(sessionID string) []PlanReport {
