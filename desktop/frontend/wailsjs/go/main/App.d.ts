...
export function AccountRefresh():Promise<engine.AccountState>;
...
export function CompleteAccountSignIn():Promise<engine.AccountState>;
...
export function ListTTSVoices():Promise<Array<engine.TTSVoiceInfo>>;
