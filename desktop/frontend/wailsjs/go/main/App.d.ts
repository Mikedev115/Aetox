...
export function ActiveAgent():Promise<string>;
...
export function DeleteAgentProfile(arg1:string,arg2:string):Promise<void>;
...
export function ListAgentProfiles():Promise<Array<agent.Profile>>;
...
export function ListSubagentProfiles():Promise<Array<agent.Profile>>;
...
export function PrimaryAgents():Promise<Array<string>>;
...
export function ReadAgentProfile(arg1:string,arg2:string):Promise<string>;
...
export function SetActiveAgent(arg1:string):Promise<main.ModelInfo>;

export function SetAgentProfileModel(arg1:string,arg2:string,arg3:string):Promise<void>;
