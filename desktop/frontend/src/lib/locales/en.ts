...
export const en: Record<keyof typeof th, string> = {
  ...
  'bgTasks.tab': 'Background tasks',
  'bgTasks.runningCount': '{n} background task(s) running',
  'bgTasks.running': 'Running',
  'bgTasks.finished': 'Finished',
  'bgTasks.stop': 'Stop',
  'bgTasks.stopConfirm': 'Click again to confirm stop',
  'bgTasks.clearFinished': 'Clear finished',
  'bgTasks.stateRunning': 'running · {t}',
  'bgTasks.stateDone': 'finished in {t}',
  'bgTasks.stateKilled': 'stopped after {t}',
  'bgTasks.stateExitError': 'exited with an error after {t}',
  'bgTasks.empty': 'Nothing is running in the background — the agent starts these itself when it needs a dev server or a long-running log.',
  'bgTasks.stopFailed': 'Could not stop it: {err}',
...
'settings.agentOverrides': 'overrides a built-in',
  ...
  'settings.editAgentDesc': 'Opened from the Agent team page — saving always lands in the agents’ home.',
