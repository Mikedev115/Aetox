...
export const en: Record<keyof typeof th, string> = {
  ...
  'settings.skillsDesc': 'Every tool the assistant can call right now — the ones built into the app, plus external skills from ~/.agents/skills and ~/.claude/skills (SKILL.md folders)',
  'settings.skillsBuiltin': 'BUILT IN ({n})',
  'settings.skillsAlwaysOn': 'always on',
