...
export const th = {
  ...
  'bgTasks.tab': 'งานเบื้องหลัง',
  'bgTasks.runningCount': 'งานเบื้องหลังกำลังทำงาน {n} งาน',
  'bgTasks.running': 'กำลังทำงาน',
  'bgTasks.finished': 'เสร็จแล้ว',
  'bgTasks.stop': 'หยุด',
  'bgTasks.stopConfirm': 'กดอีกครั้งเพื่อยืนยันหยุด',
  'bgTasks.clearFinished': 'ล้างที่เสร็จแล้ว',
  'bgTasks.stateRunning': 'กำลังทำงาน · {t}',
  'bgTasks.stateDone': 'เสร็จใน {t}',
  'bgTasks.stateKilled': 'ถูกหยุดหลัง {t}',
  'bgTasks.stateExitError': 'จบแบบผิดพลาดหลัง {t}',
  'bgTasks.empty': 'ยังไม่มีคำสั่งที่รันเบื้องหลัง — เอเจนต์จะเปิดไว้เองเวลาต้องใช้ dev server หรือ log ที่รันค้างไว้',
  'bgTasks.stopFailed': 'หยุดไม่สำเร็จ: {err}',
