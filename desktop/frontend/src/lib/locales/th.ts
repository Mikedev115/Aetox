...
export const th = {
  ...
  'settings.baseUrlDesc': 'แก้ได้ถ้า provider รันคนละพอร์ตหรือคนละเครื่อง — พอร์ต server ของ LM Studio, Ollama บนเครื่องอื่น, หรือผ่าน proxy',
  ...
  'settings.signInRestricted': 'ใช้ช่องทางเข้าสู่ระบบของผลิตภัณฑ์อื่น ผู้ให้บริการปิดได้ทุกเมื่อ และเงื่อนไขแพ็กเกจของคุณอาจไม่อนุญาต — บัญชีของคุณ คุณตัดสินใจเอง',
  ...
  'settings.toolsDesc': 'สิ่งที่ผู้ช่วยรันได้จริง — ที่ติดมากับโปรแกรม ที่มีเฉพาะบนเดสก์ท็อป และที่ต่อมาจาก MCP server',
  'settings.close': 'ปิด',
  ...
  'settings.skillsInstalled': 'สกิลที่ติดตั้งแล้ว (~/.aetox/skills)',
...
**สิ่งที่ผมจะพิมพ์ต่อท้ายคำสั่ง:** $ARGUMENTS`,
  ...
  'settings.agentsSubSoon': 'เวอร์ชันนี้ยังเรียกใช้จริงไม่ได้ — เครื่องมือ task ที่ผู้ช่วยใช้สั่งซับเอเจนยังไม่มา ตอนนี้ตั้งค่าและแก้ไฟล์รอไว้ได้',
  ...
  'settings.subagentsBuiltinHint': 'ฝังมาในตัวแอป ใช้ได้เลยตั้งแต่ติดตั้ง — กดแก้ได้ ระบบจะสร้างเป็นไฟล์ของคุณทับไว้ ของเดิมไม่หาย',
  'settings.subagentsNoneOfMine': 'ยังไม่มีของคุณเอง — กดสร้างซับเอเจนใหม่ หรือกดแก้ตัวที่มากับแอปแล้วบันทึก',
  ...
  'settings.agentsHint': 'ทุกซับเอเจนคือไฟล์ .md ไฟล์เดียวใน subagents/ จะแก้ในนี้หรือแก้ไฟล์ตรงๆ ก็ได้ — ตั้งชื่อชนกับของที่มากับแอปได้ ของคุณจะถูกใช้แทน',
  ...
  'settings.agentBodyHint': 'ส่วนหัวระหว่าง --- คือค่าตั้งค่า (description, model, tools, deny, steps) ที่เหลือคือบทบาทที่ส่งให้ซับเอเจน',
...
description: อธิบายสั้นๆ ว่าซับเอเจนนี้รับงานอะไร (โชว์ในหน้านี้)
tools:
deny:
steps:
---

บอกว่ามันรับงานแบบไหน ต้องคืนผลลัพธ์หน้าตายังไง อะไรที่ห้ามทำ
