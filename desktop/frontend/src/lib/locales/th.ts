...
export const th = {
  ...
  'guide.intro': 'อยากรู้เรื่องไหนต่อครับ',
  'guide.q1': 'สกิล กับ พรอมต์สำเร็จรูป ต่างกันยังไง',
  'guide.a1': `ต่างกันที่ **ใครเป็นคนเรียก** ครับ ไม่ใช่ที่เนื้อใน
...
2. พรอมต์สำเร็จรูปคุณกดเอง รู้ตัวเสมอ ส่วนสกิลโมเดลหยิบไปใช้ได้โดยคุณไม่ได้สั่ง`,
  'guide.q2': 'พรอมต์สำเร็จรูปใช้ยังไง',
  'guide.a2': `พิมพ์ \`/\` ในช่องแชท (หรือกดปุ่ม \`/\`) แล้วเลือกจากรายการ
...
**เพิ่มเองได้** ที่ ตั้งค่า → พรอมต์สำเร็จรูป กดสร้างใหม่ ใส่รูปหน้าปกได้ด้วย และแก้ของที่มีอยู่ได้ทุกตัว (ของเดิมไม่หาย ลบของคุณเมื่อไหร่มันกลับมาเอง)`,
  'guide.q3': 'ต่อโมเดลจริงยังไง ทำไมต้องต่อเอง',
  'guide.a3': `Aetox สร้างโดยนักพัฒนาคนเดียว ไม่มีทุนไปซื้อโมเดลมาแจกฟรี — ตรงไปตรงมาแบบนั้นครับ แลกมาด้วยข้อดีคือคุณเลือกเองได้ว่าจะเชื่อใจใคร
...
รองรับ 13 ผู้ให้บริการ สลับได้ตลอด ไม่ผูกมัด`,
  'guide.q4': 'ข้อมูลของผมปลอดภัยแค่ไหน',
  'guide.a4': `**ไม่มีเซิร์ฟเวอร์ของเราคั่นกลางเลย** ประวัติแชทและไฟล์โปรเจกต์อยู่ในเครื่องคุณล้วนๆ (SQLite ในเครื่อง) เราไม่เห็นอะไรทั้งนั้น
...
ถอดเสียง อ่านรูป อ่านวิดีโอ ทำในเครื่องทั้งหมด ไฟล์ไม่ได้ถูกอัปโหลดไปไหน`,
  'guide.q5': 'Aetox ทำอะไรได้บ้าง',
  'guide.a5': `มีเครื่องมือในตัว 22 ตัว ที่เด่นคือกลุ่มที่**เติมประสาทสัมผัสให้โมเดล**:
...
**จุดสำคัญ** เครื่องมือทั้งหมดนี้เสิร์ฟให้ทุกโมเดลเท่ากัน โมเดลเล็กราคาถูกก็ได้ของครบเหมือนกัน — ความสามารถอยู่ที่สถาปัตยกรรม ไม่ใช่ราคาโมเดล`,
  'guide.q6': 'ใครทำ Aetox และทำไป',
  'guide.a6': `นักพัฒนาคนเดียวครับ ไม่มีทีม ไม่มีนักลงทุน ทุกบรรทัดเขียนโดยคนที่ใช้มันทำงานจริงทุกวัน
