...
export const th = {
  ...
  'chat.inputPlaceholder': 'พิมพ์คำขอของคุณ… (กด / ดูพรอมต์สำเร็จรูป · + ดูคำสั่งทั้งหมด)',
  ...
  'settings.promptBodyHint': 'ใส่ $ARGUMENTS ตรงที่อยากให้แทนด้วยข้อความที่พิมพ์ตามหลังคำสั่ง',
