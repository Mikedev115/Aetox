...
**สิ่งที่ผมจะพิมพ์ต่อท้ายคำสั่ง:** $ARGUMENTS`,
  ...
  'settings.subagentsDesc': 'ผู้ช่วยตัวแทนคือลูกมือภายในที่ผู้ช่วยเรียกใช้เองระหว่างทำงาน — คุยตรงกับมันไม่ได้ ไม่เห็นประวัติแชท คืนแค่ผลลัพธ์สุดท้าย และมีเพดานรอบทำงานของตัวเอง ส่วนตัวแทนที่รับงานและคุยได้ อยู่ที่หน้าทีมเอเจน',
  'settings.subagentsMine': 'ของคุณ',
  'settings.subagentsMineHint': 'ไฟล์ .md ที่คุณเขียนเองในโฟลเดอร์ผู้ช่วยตัวแทน แก้ ลบ หรือเพิ่มได้ตามใจ',
  ...
  'settings.subagentsNoneOfMine': 'ยังไม่มีของคุณเอง กดสร้างผู้ช่วยตัวแทนใหม่ หรือกดตั้งค่าตัวที่มากับแอปแล้วบันทึก',
...
'settings.agentOverrides': 'ทับของแอป',
  ...
  'settings.agentNew': 'สร้างผู้ช่วยตัวแทนใหม่',
  ...
  'chat.talkingTo': 'กำลังคุยกับ {name} — เอเจนจากออฟฟิศ',
