...
'settings.agentOverrides': 'ทับของแอป',
  'settings.agentIsChair': 'อยู่ในทีมเอเจน',
  'settings.agentIsChairTip': 'ตัวนี้มีที่นั่งในทีมเอเจน — ดูงานที่รับไปแล้วและคุยตรงได้ที่หน้านั้น ตรงนี้คือที่ตั้งค่ามัน',
  'settings.agentIsDelegate': 'ผู้ช่วยเรียกเอง',
  'settings.agentIsDelegateTip': 'ไม่ได้อยู่ในทีมเอเจน เพราะคุณไม่ได้ส่งงานให้มันตรงๆ — ผู้ช่วยเรียกใช้เองระหว่างทำงานของมัน ที่นี่คือที่เดียวที่เห็นมันได้',
  ...
  'office.settingsNote': 'หน้านี้คือคนที่คุณส่งงานให้ได้ ตั้งค่าโมเดลและเครื่องมือของแต่ละคนอยู่ที่ การตั้งค่า › ซับเอเจน — ที่นั่นยังมีตัวที่ผู้ช่วยเรียกใช้เองด้วย ซึ่งไม่ได้มีที่นั่งในทีมนี้',
