...
export const th = {
  ...
  'chat.subagentStep': 'งานของผู้ช่วยตัวแทน',
  ...
  'chat.usedAgents': 'ตัวแทน {n} ตัว',
  'chat.agent': 'ตัวแทน',
  'chat.usedSubagents': 'ผู้ช่วยตัวแทน {n} ตัว',
  'chat.subagent': 'ผู้ช่วยตัวแทน',
...
**สิ่งที่ผมจะพิมพ์ต่อท้ายคำสั่ง:** $ARGUMENTS`,
  ...
  // Two rows, one pair of words (COMPANY.md §4): ตัวแทน and ผู้ช่วยตัวแทน.
  // The room on the sidebar keeps its own name (ทีมเอเจน); these are the kinds.
  'settings.team': 'ตัวแทน',
  'settings.subagents': 'ผู้ช่วยตัวแทน',
  'settings.teamDesc': 'ตัวแทนคือพนักงานที่รับงานทั้งก้อนไปทำแล้วคืนไฟล์ให้ — คุยตรงกับเขาได้ที่หน้าทีมเอเจน หน้านี้คือที่ตั้งค่าว่าแต่ละคนใช้โมเดลอะไร มีเครื่องมืออะไร',
  'settings.teamNew': 'สร้างตัวแทนใหม่',
  'settings.teamNoneOfMine': 'ยังไม่มีของคุณเอง กดสร้างตัวแทนใหม่ หรือกดตั้งค่าตัวที่มากับแอปแล้วบันทึก',
  'settings.teamMineHint': 'ไฟล์ .md ที่คุณเขียนเองในโฟลเดอร์ตัวแทน แก้ ลบ หรือเพิ่มได้ตามใจ',
  'settings.teamOpenPage': 'ไปหน้าทีมเอเจน',
  'settings.subagentsDesc': 'ผู้ช่วยตัวแทนคือลูกมือภายในที่ฝังมากับระบบ — ผู้ช่วยเรียกใช้เองระหว่างทำงาน คุยตรงกับมันไม่ได้ ไม่เห็นประวัติแชท คืนแค่ผลลัพธ์สุดท้าย และเพิ่มหรือแก้ไขไม่ได้ ถ้าอยากได้คนทำงานแบบของคุณเอง สร้างเป็นตัวแทนที่หน้าทีมเอเจน',
...
'settings.agentOverrides': 'ทับของแอป',
  ...
  'settings.agentsHint': 'ทุกโปรไฟล์คือไฟล์ .md ไฟล์เดียว จะตั้งค่าในนี้หรือแก้ไฟล์ตรงๆ ก็ได้ ตั้งชื่อชนกับของที่มากับแอปได้ ของคุณจะถูกใช้แทน — แต่ชื่อของตัวแทนกับผู้ช่วยตัวแทนใช้ซ้ำกันไม่ได้ เพราะความจำและประวัติงานผูกกับชื่อ',
  'settings.editAgentTitle': 'ตั้งค่าตัวแทน',
  'settings.editAgentDesc': 'เปิดมาจากหน้าทีมเอเจน — บันทึกแล้วไฟล์อยู่ในบ้านของตัวแทนเสมอ',
  ...
  'settings.agentDescriptionPlaceholder': 'คนนี้รับงานแบบไหน (โชว์ในหน้ารวม)',
  ...
  'office.hiringNote': 'เพิ่มคนในทีม = วางไฟล์ .md เพิ่มหนึ่งไฟล์ ไม่ต้องอัปเดตแอป',
  'office.settingsNote': 'หน้านี้คือคนที่คุณส่งงานให้ได้ — เฟืองบนการ์ดคือที่ตั้งค่าแต่ละคน ส่วนผู้ช่วยตัวแทน (ลูกมือภายในที่ผู้ช่วยเรียกใช้เอง คุยตรงไม่ได้) อยู่ที่ การตั้งค่า › ผู้ช่วยตัวแทน',
  'office.openFolder': 'เปิดโฟลเดอร์ทีมงาน',
  'office.openSource': 'ไปที่แชท',
  'office.chat': 'แชทกับตัวแทนนี้',
  'chat.talkingTo': 'กำลังคุยกับ {name} — ตัวแทนจากทีมเอเจน',
