...
<div class="insp-scroll">
  <div class="panel">
    <div class="p-h"><span class="lbl"><span class="arw">▾</span> <span class="eyebrow">{t('reviewPane.filesChanged', { count: cockpit.changedFiles.length })}</span></span></div>
  ...
  <div class="panel">
    <div class="p-h">
      <span class="lbl"><span class="arw">▾</span> <span class="eyebrow">{t('reviewPane.diff')}</span></span>
    </div>
    <div class="diff">
  ...
  <div class="panel">
    <div class="p-h">
      <span class="lbl"><span class="arw">▾</span> <span class="eyebrow">{t('reviewPane.testResult')}</span></span>
      {#if cockpit.test.cases.some((c) => c.state === 'running')}<span class="spin">↻</span>{/if}
    </div>
    <div class="p-b">
  ...
  <div class="panel">
    <div class="p-h"><span class="lbl"><span class="arw">▾</span> <span class="eyebrow">{t('reviewPane.commandHistory', { count: cockpit.commandHistory.length })}</span></span></div>
    <div class="p-b">
