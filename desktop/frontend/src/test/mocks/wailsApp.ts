...
export const RemoteHosts = vi.fn(async (..._args: any[]) => ({ this: { hostname: 'PC', os: 'windows', arch: 'amd64', version: 'Windows 11 (26200)', cpu: '', cpus: 8, memBytes: 16 * 2 ** 30 }, active: '', hosts: [] as any[], ssh: 'C:\\Windows\\System32\\OpenSSH\\ssh.exe', sshError: '', engine: 'release' }))
export const SaveRemoteHost = noop()
export const ForgetRemoteHost = noop()
export const ConnectRemote = noop()
export const DisconnectRemote = noop()
export const StopRemoteEngine = noop()
export const RemoteEngineLog = str()
export const HomeDir = strFn('/home/u')
export const MachineInfo = vi.fn(async (..._args: any[]) => ({ hostname: 'box', os: 'linux', arch: 'amd64', version: 'Ubuntu 26.04 LTS', cpu: '', cpus: 4, memBytes: 8 * 2 ** 30 }))
export const ListDir = vi.fn(async (..._args: any[]) => ({ path: '/home/u', parent: '/home', entries: [] as any[], truncated: false }))
...
export const CompactSession = vi.fn(async (_id: string) => ({}))
...
export const GitCommitFiles = vi.fn(async (_msg: string, _files: string[]) => ({ outcome: 'committed', hash: 'abc1234' }))
...
export const OpenAgentHome = noop()
...
export const ProgramIcon = strFn('')
export const BrowseForComputerApp = strFn('')
...
export const SessionReviewAuto = boolFn(false)
export const SetSessionReviewAuto = noop()
export const RunSessionReview = vi.fn(async (..._args: any[]) => 0)
...
export const ApplyMemoryLines = noop()
...
export const MemoryScopeInfo = vi.fn(async (scope: string) => ({ scope, bytes: 0, maxBytes: 8192, full: false }))
export const ForgetMemoryScope = noop()
export const AdoptMemoryScope = noop()
export const SaveLearnedEntry = noop()
export const AddLearnedEntry = noop()
export const MoveLearnedEntry = noop()
...
// คลังสตูดิโอ (desktop/studio_library.go): empty shelf by default, so the page
// renders its empty-state sentence; a test that wants rows sets them.
export const StudioLibraries = arr()
export const StudioScanning = boolFn(false)
export const AddStudioLibrary = boolFn(true)
export const AddStudioLibraryAt = boolFn(true)
export const RescanStudioLibrary = boolFn(true)
export const RemoveStudioLibrary = arr()
export const RevealStudioLibrary = noop()
export const CancelStudioScan = noop()
export const StudioAssets = vi.fn(async (..._args: any[]) => ({ rows: [], total: 0, page: 1, pages: 1, categories: [] }))
export const StudioThumbs = vi.fn(async (..._args: any[]) => ({}) as Record<string, string>)
export const StudioSetKind = noop()
export const StudioSetHidden = noop()
export const RevealStudioAsset = noop()
...
export const ForgetProject = vi.fn(async (..._args: any[]): Promise<engine.ProjectStatus | undefined> => undefined)
...
export const OpenProjectPath = vi.fn(async (..._args: any[]): Promise<engine.ProjectStatus | undefined> => undefined)
...
export const PullRequestsState = vi.fn(async (_state?: string) => PullRequests())
...
export const SuggestPRDetails = vi.fn(async (_head?: string, _base?: string) => ({ title: 'feat: sample title', body: '## Summary\nSample body' }))
export const ReviewPullRequest = vi.fn(async (_num?: number) => '### 📋 Overview & Highlights\nSample review')
...
export const SupportedThinkLevelsFor = arr()
...
export const HeadName = str()
export const SetHeadName = noop()
