...
export const ActiveAgent = vi.fn(async (..._args: any[]) => 'build')
...
const modelInfo = () => ({
  provider: 'aetox', modelName: 'test', thinkLevel: '', approval: 'ask', agent: 'build',
...
export const ReadAgentProfile = str()
export const SaveAgentProfile = noop()
export const DeleteAgentProfile = noop()
export const SetActiveAgent = vi.fn(async (..._args: any[]) => modelInfo())
export const PrimaryAgents = vi.fn(async (..._args: any[]) => ['build', 'plan'])
export const SetAgentProfileModel = noop()
