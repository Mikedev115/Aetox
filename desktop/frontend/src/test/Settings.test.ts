...
beforeEach(() => {
  ...
  // of them replaces it — an override that survived would land on the tests
  // that assert this exact list.
...
// The connections register left for ห้องความสามารถ on 14 ก.ย. 2026; its tests
// went with it (connectionsPage.test.ts).
