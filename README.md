...
ตัวเลขลอยๆ ไม่มีความหมายถ้าไม่มีอะไรให้เทียบ เราเลยลงเครื่องมือ AI ตัวอื่นไว้บนเครื่องเดียวกัน แล้ววัดพร้อมกัน (Windows 11)

**พื้นที่ที่กินในเครื่องหลังติดตั้ง** — น้อยกว่าดีกว่า

```
Aetox        เดสก์ท็อป  █                                            33 MB
Claude Code  คำสั่ง     ████████                                    236 MB
Codex CLI    คำสั่ง     █████████████                               390 MB
Zed          เดสก์ท็อป  ██████████████                              419 MB
OpenCode     คำสั่ง     █████████████████                           498 MB
Cursor       เดสก์ท็อป  ████████████████████████████                824 MB
VS Code      เดสก์ท็อป  ████████████████████████████████████████  1,171 MB
```

เทียบเดสก์ท็อปด้วยกัน Aetox เล็กกว่า Cursor **25 เท่า** เล็กกว่า VS Code **35 เท่า**

และต่อให้เอาไปเทียบกับตัวที่เป็นแค่หน้าจอพิมพ์คำสั่ง ไม่มี UI ให้กดสักปุ่ม Aetox ก็ยัง**เล็กกว่า Claude Code 7 เท่า** — ทั้งที่มีหน้าต่างแชท เบราว์เซอร์ในตัว อ่านรูป ถอดเสียง ครบอยู่ข้างใน

**เวลาเปิดและ RAM** — เทียบกับแอปเดสก์ท็อปด้วยกัน (Zed เขียนด้วย Rust เป็นแอปเนทีฟที่ขึ้นชื่อเรื่องเร็ว เป็นไม้บรรทัดที่โหดกว่าการไปเทียบกับแอปที่อืดอยู่แล้ว)
...
| **พื้นที่ในเครื่อง** | **33 MB** | 419 MB | 824 MB |

เวลาเปิดเสมอ Zed ที่ราวครึ่งวินาที ส่วน RAM ใช้ราวครึ่งเดียวของ Zed และราว 1 ใน 7 ของ Cursor
...
>
> **ที่วัดไม่ได้และไม่ขอเดาให้:** VS Code กำลังรันงานอยู่บนเครื่องที่วัด ปิดเพื่อวัดไม่ได้ จึงมีแค่ตัวเลขขนาด ·
> Claude Code / Codex CLI / OpenCode เป็นเครื่องมือแบบพิมพ์คำสั่ง ไม่มีหน้าจอแอป จึงเทียบได้แค่ขนาด
