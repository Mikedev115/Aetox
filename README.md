...
**เทียบกับแอปที่มีหน้าจอครบเหมือนกัน** — Aetox เล็กกว่า Cursor **25 เท่า** เล็กกว่า VS Code **35 เท่า** ทั้งที่ฝัง editor ตัวเดียวกัน มีเทอร์มินัล มีเบราว์เซอร์ในตัวเหมือนกัน

> **ขอบเขตที่เราไม่เคลม:** Aetox ไม่ได้มาแทน IDE ของคุณ — ไม่มี debugger, ไม่มีร้านส่วนขยายเป็นหมื่นตัว,
> LSP รองรับ Go / TypeScript / Svelte เท่านั้น สิ่งที่ตัวเลขนี้บอกคือ **เฉพาะของที่ทับกัน เราทำได้ในขนาดเท่านี้**
