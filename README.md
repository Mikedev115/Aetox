...
**เวลาที่ตัวแอปกินเอง** — วัดจากตอนกดส่ง จนถึงตอนคำขอออกจากเครื่อง ไม่รวมโมเดล

```
Aetox  0.13 มิลลิวินาที  ต่อการคุย 1 ครั้ง (ยื่น tools แกนกลาง 20 ตัว ~9.9 KB ให้โมเดล)
```
