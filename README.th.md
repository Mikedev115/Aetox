...
- **เบราว์เซอร์ในตัวแอปที่เราพัฒนาฝังเอง** — ไม่ใช่การขูดข้อมูลแบบไม่มีหน้าจอ แต่เป็นหน้าต่าง
  WebView2 ที่ประกอบเข้ามาในแอปจริง มีช่องที่อยู่ ปุ่มย้อนกลับ/ไปหน้า DevTools และชุดขนาดอุปกรณ์
  แปดแบบที่ปรับขนาดหน้าต่างจริงให้ CSS media query ทำงานจริง เอเจนเปิด อ่าน คลิก และพิมพ์
  ในแท็บเดียวกับที่คุณนั่งดูอยู่ ([ดูภาพตัวอย่าง](#เอาไปทำอะไรได้บ้าง))
...
- **ความสามารถฝังอยู่ในตัวแอป ไม่ได้มาจากพารามิเตอร์โมเดล** — OCR ไทย/อังกฤษ และการถอดเสียง
  แบบออฟไลน์ เราพัฒนาเองและฝังไว้ในไบนารีตัวเดียว โมเดล 9B/35B ที่รันในเครื่องคุณเอง
...
เพราะโต๊ะเป็นตัวตัดชุดให้แคบลง ทั้งหมดกินราว 7,727 โทเคนในทุกคำขอ ก่อนคุณจะพิมพ์อะไรด้วยซ้ำ
