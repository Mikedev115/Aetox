...
สองตัวหลัง**เขียนอะไรไม่ได้เลย โดยตั้งใจ**: รีวิวเวอร์ที่แก้สิ่งที่ตัวเองเจอคือนักเขียนคนที่สอง
แล้วจะไม่เหลือใครอ่าน · tester ที่ซ่อมเทสต์ที่ตัวเองรันคือเทสต์ที่ไม่มีใครเห็นว่ามันเคยพัง
...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.5.28.md) ·
[แผนงาน](ROADMAP.md) · [สถาปัตยกรรม](ARCHITECTURE.md)

สามอย่างที่มันทำได้วันนี้และน่ารู้ไว้:

- **Aetox ใช้โปรแกรมที่เปิดอยู่ในเครื่องคุณได้ เมื่อคุณเลือกว่าโปรแกรมไหน** มันอ่านหน้าต่าง
  ผ่านระบบช่วยการเข้าถึงของ Windows ไม่ใช่เดาพิกัดจากภาพหน้าจอ จึงเล็งไปที่ปุ่มไม่ใช่ที่จุด
  และใช้ได้กับโมเดลที่ชี้ตำแหน่งบนภาพไม่เป็นเลย ปิดไว้จนกว่าคุณจะเปิดที่
  ตั้งค่า > การใช้คอมพิวเตอร์ และตอนปิดอยู่ โมเดลไม่ได้รับเครื่องมือนี้เลย ไม่ใช่ได้ไปแล้ว
  โดนปฏิเสธ เทอร์มินัลกับเบราว์เซอร์ถูกปฏิเสธโดยตั้งใจ และคำปฏิเสธบอกว่าเครื่องมือไหนทำได้ดีกว่า
- **คุณเห็นมันทำงาน และเมาส์ยังเป็นของคุณ** ระหว่างที่มันคุมอะไรอยู่ ขอบจอมีแสงวิ่งรอบ
  และมีตัวชี้อีกอันบอกว่ากำลังกดปุ่มไหน เคอร์เซอร์ของคุณไม่ขยับเลย เพราะไม่มีอะไรในระบบนี้
  เล็งด้วยพิกัด ตัวชี้นั้นจึงเป็นการรายงานว่ากดอะไร ไม่ใช่สิ่งที่ใช้กด
- **เวลาล้มเหลว มันบอกว่าล้มแบบไหนในหกแบบ** จอล็อก, หน้าต่างที่รันด้วยสิทธิ์สูงกว่า,
  ปุ่มที่ถูกปิดอยู่, ปุ่มที่ย้ายไปแล้ว, ปุ่มที่ไม่รับคำสั่งนั้น และโปรแกรมที่หยุดตอบ
  คือหกสถานการณ์ที่มีทางแก้คนละอย่าง เครื่องมือตัวก่อนหน้ารายงานทั้งหกแบบว่า "failed"
  เหมือนกันหมด ซึ่งเป็นเหตุผลที่มันถูกลบทิ้งแทนที่จะถูกไล่แก้
