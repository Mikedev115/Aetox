...
- **งานสไลด์คือสิ่งที่มันทำได้ดีที่สุด** — สั่งให้ทำเด็คแล้วได้ไฟล์ `.html` เดียวจบ
  ที่เปิดในห้องสไลด์ เลื่อนดูทีละหน้า นำเสนอเต็มจอ แล้วส่งออกเป็น `.pptx` `.pdf`
  หรือรูปภาพ ได้จากห้องนั้นเลย สไลด์ถูกวางบนกล่อง 1280x720 ซึ่งเท่ากับหน้าจอกว้าง
  ของ PowerPoint พอดี เด็คที่ได้จึงเปิดใน PowerPoint ได้โดยไม่เพี้ยน
...
**เด็คนำเสนอ คือสิ่งที่มันทำได้ดีที่สุด** บอกหัวข้อกับสิ่งที่อยากได้ แล้วเด็คจะกลับมาเป็นไฟล์
`.html` เดียวจบ ที่เปิดในห้องสไลด์ เลื่อนดูทีละหน้า นำเสนอเต็มจอ แล้วส่งออกเป็น `.pptx`
`.pdf` หรือรูปภาพ ได้จากห้องนั้นเลย กล่องของสไลด์คือ 1280x720 ซึ่งเท่ากับ 13.333 x 7.5 นิ้ว
ที่ 96dpi พอดี คือหน้าจอกว้างของ PowerPoint เป๊ะ ๆ เด็คจึงไปเปิดต่อในนั้นได้โดยไม่เพี้ยน
...
หน้าที่ของเครื่องยนต์คือทำเทิร์นให้จบ สี่อย่างนี้คือความผิดพลาดที่มันรับไว้เอง แทนที่จะโยนมาให้คุณ
