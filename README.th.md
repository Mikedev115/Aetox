...
- **สร้างสไลด์นำเสนอได้** — ตัวเด็คคือไฟล์ `.html` เดียวจบ เป็นของคุณ แก้ด้วยมือได้
  และเปิดได้บนเครื่องไหนก็ตามที่มีเบราว์เซอร์ มันเปิดในห้องสไลด์ตั้งแต่วินาทีที่เขียนเสร็จ
  เลื่อนดูทีละหน้าและนำเสนอเต็มจอได้จากตรงนั้น รองรับการส่งออกเป็น `.pdf` `.png` `.jpg`
  ส่วนการแปลงไฟล์เป็นงานของแอป ไม่ใช่งานของโมเดล สไลด์วางบนกล่อง 1280x720
...
เป็นไฟล์เดียวที่เป็นของคุณ แก้ด้วยมือได้ และเปิดได้บนเครื่องไหนก็ตามที่มีเบราว์เซอร์
