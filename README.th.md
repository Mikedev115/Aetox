...
- **ความสามารถฝังอยู่ในตัวแอป ไม่ได้มาจากพารามิเตอร์โมเดล** — OCR ไทย/อังกฤษ ถอดเสียงออฟไลน์
  และการเขียนไฟล์ Office จริง เราพัฒนาเองทั้งหมดและฝังไว้ในไบนารีตัวเดียว โมเดล 9B/35B
  ที่รันในเครื่องคุณเองจึงทำงานเหล่านี้ได้เท่าโมเดลตัวใหญ่ ไม่ใช่โมเดลทำเอง แอปทำให้
...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.5.6.md) ·
