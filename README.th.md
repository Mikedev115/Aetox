...
และไม้ผลัดคือ path ของไฟล์ ไม่ใช่เนื้อหา แยกกันอีกเรื่องคือ **ลูกมือ** (ซับเอเจน) สี่ตัว
(`explore` `general` `reviewer` `tester`) ซึ่งเป็นผู้ช่วยภายใน — เป็นชุดตายตัว เพิ่มไม่ได้ โดยตั้งใจ
แต่ตั้งแต่ 1.6.0 ปรับแต่ละตัวได้: โมเดลกับผู้ให้บริการ คำสั่ง เพดาน steps และรูปลักษณ์
ไม่ใช่สิ่งที่มันเอื้อมถึง สองตัวหลัง**เขียนอะไรไม่ได้เลย โดยตั้งใจ**: รีวิวเวอร์ที่แก้สิ่งที่ตัวเองเจอ
คือนักเขียนคนที่สอง แล้วจะไม่เหลือใครอ่าน · tester ที่ซ่อมเทสต์ที่ตัวเองรันคือเทสต์ที่ไม่มีใครเห็นว่ามันเคยพัง
