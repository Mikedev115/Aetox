...
| **มีห้องอะไร** | ผู้ช่วย · ความสามารถ · โปรเจกต์ · เอเจนเฉพาะทาง · งานวิดีโอ · ผลงาน | โค้ด และมี Git กับไทมไลน์เป็นแท็บ |
| **แผงขวามือ** | มี | มี |
...
ที่เปลี่ยนชื่อ ตัดคน หรือลบทิ้งได้ จัดการทีมที่ ตั้งค่า › ทีมเอเจน และชิปข้างช่องพิมพ์บอกว่าใครตอบ
และจ้างจากทีมไหน

เอเจนไม่เรียกหากันเอง ดาวดวงนี้มีศูนย์กลางเดียว งานหลายขั้นเดินผ่านผู้ช่วยเสมอ
และไม้ผลัดคือ path ของไฟล์ ไม่ใช่เนื้อหา แยกกันอีกเรื่องคือ **ซับเอเจน** สี่ตัว
...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.6.2.md) ·
[แผนงาน](ROADMAP.md) · [สถาปัตยกรรม](ARCHITECTURE.md)

สามอย่างที่มันทำได้วันนี้และน่ารู้ไว้:

- **หน้าต่างกับเครื่องยนต์เป็นสอง process และเครื่องยนต์ไปอยู่เครื่องอื่นได้** ทุกอย่างที่คิด
  อ่านไฟล์ รันคำสั่ง และคุยกับเซิร์ฟเวอร์ MCP คือ `aetox-engine` ที่ติดตั้งข้าง `aetox.exe`
  และคุยกันผ่าน socket เส้นเดียว — ในเครื่องเดียวกันก็เดินทางนี้ เครื่องอื่นจึงเป็นโค้ดเดิม
  บนสายที่ยาวขึ้น ที่ ตั้งค่า › เครื่องระยะไกล เพิ่มเครื่อง Linux ด้วยชื่อ `ssh` ของมัน
  กดครั้งเดียว แอปส่งเครื่องยนต์รุ่นนี้ไปทาง `ssh` เริ่มมัน เปิดอุโมงค์ และต่อใหม่เองเมื่อสายขาด
  คีย์ผู้ให้บริการอยู่ที่เครื่องที่หน้าต่างรัน: เครื่องยนต์ยื่นคำขอให้จอเซ็น และจอเซ็นให้เฉพาะ
  ปลายทางที่มันรู้เองว่าเป็นของผู้ให้บริการนั้น
- **ผู้ช่วยมีหน้าตา และนั่งอยู่บนเดสก์ท็อปได้** มาสคอตหุ่นยนต์ตัวเดียวของทั้งบริษัท วาดจากโค้ด
  แต่งตัวตามเอเจนแต่ละคน ทักคุณด้วยชื่อ มีท่าตามสิ่งที่เกิดขึ้น (ฟัง อ่าน เครื่องมือกำลังรัน
  ล้ม) เงียบห้านาทีก็นอนบนหมอน และอ่านคำตอบที่จบแล้วออกเสียงด้วยเสียงของเครื่อง
  ตั้งค่า › อวตาร ปล่อยมันออกจากหน้าต่างไปบนเดสก์ท็อป — หน้าต่าง Win32 โปร่งใสรายพิกเซล
  จังหวะเฟรมตามจอที่มันอยู่ ไม่มีเบราว์เซอร์ตัวที่สอง — ย่อขยายได้ 64–240 px ลากไปไหนก็ได้
- **เอเจนถูกจ้างผ่านทีม และปุ่ม `+` เป็นประตูเดียวของทุกอย่างที่ใส่เข้าข้อความ** ทีมคือรายชื่อเอเจน
  บนโต๊ะเดียว แชทจ้างจากทีมเดียวหรือไม่จ้างเลย และชิปข้างช่องพิมพ์บอกว่าใครตอบและจ้างจากทีมไหน
  เอเจนแต่ละคน และตอนนี้ซับเอเจนแต่ละตัว เลือกผู้ให้บริการกับโมเดลของตัวเองได้ เมนู `+` รวม
  ไฟล์แนบ ชุดคำสั่ง `/` เอเจน `@` และแท็บที่เปิดอยู่ไว้ในรายการเดียวที่ค้นข้ามกันได้
  และหน้าต่างพับแผงข้างแทนที่จะไม่ยอมเล็กกว่า 1100 px

**ต่อไป** — เครื่องมือของหน้าต่างเมื่อเครื่องยนต์อยู่ไกล (เฟส 4 ของ §248) · สลับผู้ให้บริการ
ข้ามบัญชีอัตโนมัติเมื่อโควต้าหมดกลางเซสชัน · โปรแกรมเอเจนภายนอกเป็นเครื่องยนต์ (§258 สร้างรอยต่อไว้แล้ว)
