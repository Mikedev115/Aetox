...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.5.18.md) ·
[แผนงาน](ROADMAP.md) · [สถาปัตยกรรม](ARCHITECTURE.md)

สามอย่างที่มันทำได้วันนี้และน่ารู้ไว้:

- **สลับโมเดลกลางคำตอบได้ และตัวถัดไปถูกพิสูจน์ก่อนถึงคิวของมัน** ปุ่มเครื่องยนต์ทั้งสี่
  ไม่ปฏิเสธระหว่างเทิร์นอีกแล้ว — คำสั่งถูกรับตอนที่คุณกด ไปจอดรอที่ขอบเทิร์น และเมนูบอกว่า
  อะไรรออยู่กับยกเลิกยังไง ระหว่างที่ตัวเก่ายังตอบ ping ขนาดหนึ่งโทเคนพิสูจน์คีย์กับรูปแบบสาย
  ของปลายทางถัดไปให้เสร็จ ยกเว้นรันไทม์ที่เก็บน้ำหนักโมเดลไว้ในหน่วยความจำของเครื่องนี้เอง
  ซึ่งการพิสูจน์แปลว่าโหลดมันขึ้นมานั่งข้างตัวที่ยังพูดอยู่
- **แชตที่เปิดกลับมาวันถัดไป ยังถือสิ่งที่เกิดขึ้นข้างในไว้ครบ** ลูกน้องทำอะไรไปบ้าง
  ถูกเก็บไว้ใต้การ์ดที่จ้างมัน และคำถามที่ถามคุณ พร้อมคำตอบของคุณ ถูกเก็บไว้บนแถวของมัน
  ทั้งสองอย่างเคยอยู่แต่ในเทิร์นที่กำลังวิ่งและหายไปพร้อมมัน
- **คำตอบที่คุณกำลังจะพิมพ์ ถูกพิมพ์ไว้ให้แล้ว** เทิร์นที่จบด้วยการยื่นทางเลือกให้
  จะเขียนคำตอบของคุณลงช่องพิมพ์เป็นตัวจาง กด Tab รับไปใช้ กดอีกทีสลับไปอีกตัวเลือก
  พิมพ์อะไรก็หายไป ไม่มีอะไรถูกส่งโดยที่คุณไม่ได้เป็นคนส่ง
