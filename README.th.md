...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.5.15.md) ·
[แผนงาน](ROADMAP.md) · [สถาปัตยกรรม](ARCHITECTURE.md)

สามอย่างที่มันทำได้วันนี้และน่ารู้ไว้:

- **ย้อนได้มากกว่าเทิร์นล่าสุด** ทุกเทิร์นจดไฟล์ที่มันแก้ไว้ ปุ่มย้อนกลับจึงเอาเทิร์นล่าสุดคืนได้
  และมีชิปที่สองที่ลิสต์จุดก่อนหน้านั้นตามเวลาและตามข้อความที่คุณพิมพ์
  โดยบอกชื่อไฟล์จริงที่จะเอากลับมาก่อนลงมือทำ
- **มันอ่านรูปทรงของโปรเจกต์ก่อนอ่านไฟล์** แผนที่โค้ดเดินทั้งโปรเจกต์ จัดอันดับไฟล์ตามการถูกพึ่งพา
  แล้วบีบลงราวหนึ่งพันโทเคน การวิเคราะห์เดียวกันนี้คือสิ่งที่วาดแท็บกราฟ รูปกับแผนที่ของโมเดล
  จึงเพี้ยนจากกันไม่ได้
- **เทิร์นหนึ่งอ่านตามที่มันเกิดจริง** คิด ใช้เครื่องมือ คิดอีก — เป็นช่วงงานที่มีนาฬิกาของตัวเอง
  แทนที่จะเป็นตัวเลขเดียวที่บวกรวมมาคร่อมแถวเดียวที่พับอยู่
