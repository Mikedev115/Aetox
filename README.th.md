...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.5.17.md) ·
[แผนงาน](ROADMAP.md) · [สถาปัตยกรรม](ARCHITECTURE.md)

สามอย่างที่มันทำได้วันนี้และน่ารู้ไว้:

- **ตัดต่อวิดีโอจบในเครื่อง** เอเจนตัดต่อใช้ kinocut กับตัวเรนเดอร์ฉากที่ปักรุ่นและตรวจ SHA ทุกไฟล์
  ห้องตัดข้างแชตแสดงงานตัดเป็นบัญชีพร้อมเครื่องเล่น และตัวเลขทุกตัวอ่านจากไฟล์จริง
  ไม่ใช่จากคำพูดของเอเจน
- **พูดกับมันได้ ให้มันอ่านให้ฟังได้** ไมค์ในช่องพิมพ์ถอดเสียงลงดราฟต์ ปุ่มฟังใต้คำตอบอ่านออกเสียง
  เจ้าเสียงสลับได้จากหน้าตั้งค่า 15 เจ้า โลคัลเป็นค่าเริ่มต้น เสียงที่อัดไม่ออกจากเครื่อง
  จนกว่าจะเลือกแถวคลาวด์เอง
- **โต๊ะขวามือเป็นของแชตของมัน** หน้าเว็บที่เอเจนของแชตเบื้องหลังเปิด ไม่โผล่ทับจอที่กำลังดู
  มันรอบนโต๊ะของแชตตัวเอง หน้าต่างยังมีชีวิตให้เอเจนทำงานต่อ และสลับกลับไปเมื่อไหร่
  ก็ได้หน้าเดิมคืนโดยไม่รีโหลด
