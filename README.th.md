...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.5.16.md) ·
[แผนงาน](ROADMAP.md) · [สถาปัตยกรรม](ARCHITECTURE.md)

สามอย่างที่มันทำได้วันนี้และน่ารู้ไว้:

- **สั่งยี่สิบงานได้ยี่สิบงาน** สี่ตัวทำพร้อมกัน ที่เหลือรอคิวตามลำดับที่ถูกสั่ง แล้วเริ่มเองทันทีที่มีที่ว่าง
  ไม่มีการปฏิเสธ แถวที่รออยู่เห็นบนจอ และกดครั้งเดียวยกเลิกได้ทั้งแถวโดยไม่แตะสี่ตัวที่กำลังทำ
- **การเรียกเพื่อนร่วมงานต้องกดเลือก ไม่ใช่แค่พิมพ์ถูกคำ** `@` เปิดรายชื่อแล้วต้องกดเลือกจากในนั้น
  เอกสารที่วางมาแล้วบังเอิญมีคำว่า `@reviewer` อยู่ข้างใน จึงเป็นแค่ข้อความธรรมดา
  ไม่ใช่งานที่ถูกส่งไปผิดคน
- **เทิร์นหนึ่งอ่านตามที่มันเกิดจริง** เวลาคิดอยู่เหนือประโยค งานอยู่ใต้ประโยคและติดกับแถวที่มันนับ
  เป็นช่วงงานที่มีนาฬิกาของตัวเอง ของที่เสร็จแล้วพับเก็บได้ ส่วนของที่ยังทำอยู่ถูกวาดนอกที่พับ
  จึงไม่มีทางถูกพับหายไป
