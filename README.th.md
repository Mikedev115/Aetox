...
มันคือไฟล์เดียว 47.5 MB ที่มีทุกอย่างอยู่ในตัว ไม่ต้องลง runtime อะไรเพิ่ม ไม่มี `node_modules`
...
**ตัวติดตั้ง** — [aetox-amd64-installer.exe](https://github.com/Mike0165115321/Aetox/releases/latest/download/aetox-amd64-installer.exe) (20.9 MB)
...
**Aetox** ตัวเลขขนาดสองแถวกับจำนวนเทสต์สองแถว วัดใหม่เมื่อ 2026-08-18 บน v1.2.4
ประกอบหนึ่งเทิร์นวัดเมื่อ 2026-08-13 ส่วนแถวที่มี ⁽ᵈ⁾ วัดเมื่อ 2026-07-27 บน v0.9.2

| | |
|:---|---:|
| สิ่งที่คุณดาวน์โหลด | ตัวติดตั้ง 20.9 MB |
| สิ่งที่ลงไปอยู่ในเครื่อง | **47.5 MB** ไฟล์เดียว |
...
แตกออกมา แล้วอ่านขนาดของ `aetox.exe` ตัวเดียวข้างใน: 49,768,960 ไบต์ ใครก็ทำซ้ำได้ในหนึ่งนาที
มันมาแทนตัวเลข 41.5 MB ที่วัดเมื่อ 2026-08-13 ซึ่งถูกต้องในตอนนั้นและไม่ถูกแล้วตอนนี้
