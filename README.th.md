...
แกนหลักเข้าที่แล้ว [บันทึกการปล่อยรุ่น](docs/release-notes/v1.5.19.md) ·
[แผนงาน](ROADMAP.md) · [สถาปัตยกรรม](ARCHITECTURE.md)

สามอย่างที่มันทำได้วันนี้และน่ารู้ไว้:

- **พิมพ์แทรกตอนคำตอบกำลังไหล แล้วข้อความอยู่ตรงที่คุณพิมพ์** ข้อความที่แทรกเป็นส่วนหนึ่ง
  ของเทิร์นนั้นแล้ว วาดเป็นบับเบิลของคุณเองตรงจุดที่มันลง และคำตอบต่อมันอยู่ข้างใต้
  เดิมมันเป็นบับเบิลข้างเทิร์นที่วางได้แค่เหนือบล็อกสดหรือใต้บล็อกสด การแทรกครั้งที่สอง
  จึงไปกองอยู่ก้นสุด ห่างจากคำตอบที่มันเป็นต้นเหตุ และตอนนี้มันถูกเก็บลงบันทึกด้วย
  แชตที่เปิดกลับมาพรุ่งนี้แสดงคำถามกับคำตอบตามลำดับที่เกิดจริง ซึ่งเมื่อก่อนไม่มีอะไรเก็บไว้เลย
- **แท็บที่คุณยืนอยู่เป็นรูปทรง ไม่ใช่เส้นใต้** แถบแท็บจมกว่าพื้นข้างล่าง แท็บที่สดเป็นชิป
  ยกขึ้นพร้อมเส้นขอบกลาง ๆ กับไอคอนสี และแท็บกว้างเท่าชื่อของมันแทนที่จะถูกเลนตายตัวตัดสั้น
  เปิดกับปิดใช้เวลายืดความกว้าง 180ms แทนการกระโดด
- **คลังฉากเปิดครบ และการเรนเดอร์ไม่ติดอยู่ที่ 1080p อีกแล้ว** ฉากทั้ง 75 บนสี่ชั้นเปิดได้
  ด้วยทุกวิธีสะกดที่สารบัญสอนไว้ — เมื่อก่อนยี่สิบห้าอันถูกปฏิเสธ — บวก `blank` สำหรับงาน
  ที่ไม่มีฉากไหนเป็นรูปทรงนั้น การเรนเดอร์รับความละเอียดถึง 4K, mov/webm ที่มีอัลฟา,
  ลำดับภาพ PNG, GIF, เฟรมเรตแบบฟิล์มอย่าง 23.976 และตัวแปรข้อความต่อการเรนเดอร์
  ทั้งหมดนี้อยู่ในเอนจินมาตลอด และไม่มีอันไหนที่ขอได้เลย
