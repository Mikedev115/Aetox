...
แท็บบนแผงงานแปดชนิดรองรับทั้งหมด: `terminal` · `browser` · `files` · `file` · `decks` ·
`git` · `repomap` · `pr` ข้างหลังมีเอดิเตอร์ Monaco เทอร์มินัล ConPTY จริง
และสถานะ git เทียบ HEAD พร้อม +N −M
